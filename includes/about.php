<article class="about_container">
	<div class="row">
		<h1 class="work_title about_title col-xs-12">ABOUT</h1>
	</div>
	<div class="row">
		<div class="col-xs-12 col-sm-6">

			<div class="row">
				<p class="col-xs-12">Hello and welcome to my site. I am pleased that you made it here. </p>
			</div>
			<div class="row">
				<p class="col-xs-12">I am new to the web design industry and am keen to get out there and learn how to make great websites.</p>
			</div>
			<div class="row">
